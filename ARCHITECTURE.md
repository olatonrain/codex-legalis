...
- **Multi-Agent** extracts metrics directly from the saved trial record (`main_verdict`, transcript, `shadow_jury_results`) instead of re-running the full graph. This reduces benchmark time from minutes to seconds.
